...
func NewClientHandler(id int, proposer *multipaxos.Proposer, ld detector.LeaderDetector, clConnChan chan *net.TCPConn) *ClientHandler {
	return &ClientHandler{
		id:                  id,
		proposer:            proposer,
		ClientValueChanIn:   make(chan multipaxos.Value, 30000000000000000),
		ClientTimeoutChanIn: make(chan multipaxos.Value, 30000000000000000),
		LearnValueChan:      make(chan multipaxos.Value, 30000000000000000),
		responseChanIn:      make(chan multipaxos.Response, 30000000000000000),
		ld:                  ld,
		leader:              ld.Leader(),
